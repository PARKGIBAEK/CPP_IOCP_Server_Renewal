...
struct TEST_MSGDefaultTypeInternal {
  constexpr TEST_MSGDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~TEST_MSGDefaultTypeInternal() {}
  union {
    TEST_MSG _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TEST_MSGDefaultTypeInternal _TEST_MSG_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, hp_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, attack_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, buffs_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TEST_MSG, msg_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::BuffData)},
  { 9, -1, -1, sizeof(::Protocol::TEST_MSG)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::Protocol::_BuffData_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::Protocol::_TEST_MSG_default_instance_),
};

const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016Protocol.proto\022\010Protocol\"\?\n\010BuffData\022\016"
  "\n\006buffId\030\001 \001(\004\022\022\n\nremainTime\030\002 \001(\002\022\017\n\007vi"
  "ctims\030\003 \003(\004\"b\n\010TEST_MSG\022\n\n\002id\030\001 \001(\004\022\n\n\002h"
  "p\030\002 \001(\r\022\016\n\006attack\030\003 \001(\r\022!\n\005buffs\030\004 \003(\0132\022"
  ".Protocol.BuffData\022\013\n\003msg\030\005 \001(\tb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Protocol_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Protocol_2eproto = {
  false, false, 199, descriptor_table_protodef_Protocol_2eproto, "Protocol.proto", 
...
TEST_MSG::TEST_MSG(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  buffs_(arena) {
  SharedCtor();
  ...
  // @@protoc_insertion_point(arena_constructor:Protocol.TEST_MSG)
}
TEST_MSG::TEST_MSG(const TEST_MSG& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.TEST_MSG)
}

inline void TEST_MSG::SharedCtor() {
msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  msg_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
TEST_MSG::~TEST_MSG() {
  // @@protoc_insertion_point(destructor:Protocol.TEST_MSG)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void TEST_MSG::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  msg_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void TEST_MSG::ArenaDtor(void* object) {
  TEST_MSG* _this = reinterpret_cast< TEST_MSG* >(object);
  (void)_this;
}
void TEST_MSG::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void TEST_MSG::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.TEST_MSG)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Protocol.TEST_MSG.msg"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TEST_MSG::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.TEST_MSG)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.TEST_MSG)
  return target;
}

size_t TEST_MSG::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.TEST_MSG)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TEST_MSG::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    TEST_MSG::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TEST_MSG::GetClassData() const { return &_class_data_; }

void TEST_MSG::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TEST_MSG *>(to)->MergeFrom(
      static_cast<const TEST_MSG &>(from));
}


void TEST_MSG::MergeFrom(const TEST_MSG& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.TEST_MSG)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.TEST_MSG)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void TEST_MSG::InternalSwap(TEST_MSG* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TEST_MSG, attack_)
      + sizeof(TEST_MSG::attack_)
      - PROTOBUF_FIELD_OFFSET(TEST_MSG, id_)>(
...
template<> PROTOBUF_NOINLINE ::Protocol::TEST_MSG* Arena::CreateMaybeMessage< ::Protocol::TEST_MSG >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::TEST_MSG >(arena);
}
